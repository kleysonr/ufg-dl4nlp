...
import csv
import os
from lib.preprocessing import Nilc, RemoveAcentos, RemoveSmallWords
...
# Filtra apenas registros 'reliable' para criar dataset de validacao
print('Filtrando registros de validacao.')
pt_train = pt_train.loc[pt_train['label_quality'] == 'reliable']
es_train = es_train.loc[es_train['label_quality'] == 'reliable']
...
np.savetxt('output/validation_portuguese.txt', ds, fmt='%s')
...
ds = ds.to_numpy()
np.savetxt('output/validation_spanish.txt', ds, fmt='%s')